    ...
    <Modal>
      <Modal.Open opens={`income-${id}`}>
        <div
          ...
          className="group mb-1 flex cursor-pointer items-center justify-between rounded-xl border border-transparent bg-emerald-50/40 p-3 transition-all hover:border-emerald-200 hover:bg-emerald-100/50 hover:shadow-sm"
        >
          {/* LEFT: Icon & Title */}
          <div className="flex items-center gap-3">
            <HiArrowUpCircle className="h-6 w-6 text-emerald-500 transition-transform duration-300 group-hover:scale-110" />
            <span className="font-sans font-bold text-slate-700 transition-colors group-hover:text-emerald-800">
              {source}
            </span>
          </div>
          ...
          <div className="flex items-center gap-4 text-sm md:gap-6">
            ...
            <div className="hidden items-center justify-center rounded-md bg-emerald-100/60 px-2.5 py-1 text-[10px] font-black tracking-widest text-emerald-600 uppercase sm:flex">
              Income
            </div>
            ...
            <div className="flex flex-col items-end sm:flex-row sm:items-center sm:gap-6">
              ...
              <span className="font-sans text-xs font-medium text-emerald-600/60 sm:text-sm">
